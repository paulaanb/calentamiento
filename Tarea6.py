...
if customer_basket_cost < 0 or customer_basket_weight <= 0:
    ...
    if (customer_basket_cost >= 100):
        print ("¡Usted tiene envio gratis! El precio total de su pedido es de" + str(customer_cost) + "euros")
    else:
...
#Si el valor introducido es <100 el mensaje sera el mismo mas la suma del coste del envio. 
